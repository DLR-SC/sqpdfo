...
#    #feas=array([[ max_(0,  max_(  [[x], [info.ci]] - ub,  lb - [[x],[info.ci]]   )   ) ],
##										[info.ce]])
...
#    #print "compl", compl				
#    #print "----"				
#    #print "bitwise &", (lb > - options.inf) & (abs(lb - v) > options.dxmin)				
#    #print "----"				
#    I=find_((lb > - options.inf) & (abs(lb - v) > options.dxmin))
#    if not isempty_(I):
#        compl[I]=max_(compl[I],max_(0,- lm[I]))
#    I=find_((ub < options.inf) & (abs(ub - v) > options.dxmin))
#    if not isempty_(I):
#        compl[I]=max_(compl[I],max_(0,lm[I]))
#    return feas,compl,info
