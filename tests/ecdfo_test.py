...
class Test_ecdfo(unittest.TestCase):
    ...
    def test_ecdfo(self):
        ...
        correctlm = array([[0,-0.000005713064576,0,1.999997749517402,-0.999996152071198]])
        ...
        self.assertTrue(compare_array(info.g, array([-1.000001597463464,2.676871464447451e-07,9.999907066947283e-01]),self.abs_tol, 1e-7))
        self.assertTrue(compare_array(info.ae, array([[1,1,1],[1,2,3]]),self.abs_tol, self.rel_tol))
        ...
        self.assertTrue(compare_array(info.glag, array([6.661338147750939e-16,6.617876887227321e-16,-5.551115123125783e-16]), self.abs_tol, self.rel_tol))
